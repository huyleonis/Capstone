...
public class AuthActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private boolean validateForm(String email, String password) {
        if (TextUtils.isEmpty(email)) {
            Toast.makeText(AuthActivity.this, "Enter email address!", Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        if (password.length() < 6) {
            Toast.makeText(AuthActivity.this, "Password too short, enter minimum 6 characters!", Toast.LENGTH_SHORT).show();
            return false;
        }
