...
public class AccountDTO {
    ...
    public AccountDTO(int id, String username, int role, String fullname, String email, String phone, String numberId,
                      String eWallet, int vehicleId, String licensePlate, String vehicleType, String licenseId,
                      double balance, boolean isActive, boolean isEnable, boolean loginStatus, String token) {
        this.id = id;
    ...
    public static AccountDTO convertFromEntity(Account account) {
        ...
        dto.setEnable(account.getEnabled());
