...
public class AccountServiceImpl implements AccountService {
		...
		try {
			...
			if (isAvailable) {
				...
				if (account.getVehicle() != null) {
					Vehicle vehicle = checkAccountOwnVehicle(account);
					if (vehicle != null) {
	...
	@Override
	public Vehicle checkAccountOwnVehicle(Account account) {
		...
		if (vehicle != null) {
			...
			if (existingAccountHaveVehicle == null) {
				return vehicle;
			} else if (existingAccountHaveVehicle.getId() == account.getId()) {
				return vehicle;
			}
		}
