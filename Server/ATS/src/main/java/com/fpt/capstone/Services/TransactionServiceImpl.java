...
public class TransactionServiceImpl implements TransactionService {
	...
	@Override
	public List<TransactionDTO> getTransactionsForStaff(String status, int min) {
		List<Transaction> list = transactionRepos.getTransactionForStaff(status, min);
	...
	public List<TransactionDetailDTO> getDetailsByAccountId(String username) {
        ...
        @Override
        public List<TransactionDTO> getTransactionByDate(String date, String status){
            List<Transaction> list = transactionRepos.getTransactionByDate(date, status);
		List<TransactionDTO> result = new ArrayList<>();
		for (Transaction tran : list) {
			TransactionDTO dto = TransactionDTO.convertFromEntity(tran);
			result.add(dto);
        ...
        public void deleteTransaction(String id){
            transactionRepos.deleteTransaction(id);
        }
}