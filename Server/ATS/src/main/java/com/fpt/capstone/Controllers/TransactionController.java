...
public class TransactionController {
    ...
    @RequestMapping(value = "/reportMismatchTransaction/{transactionId}")
    @ResponseBody
    public String reportMismatchTransaction(@PathVariable String transactionId) {

        TransactionDTO dto = null;

        dto = transactionService.updateTransactionStatus(transactionId, "Lỗi");
