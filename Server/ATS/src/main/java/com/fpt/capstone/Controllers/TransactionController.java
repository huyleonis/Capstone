...
public class TransactionController {
	...
	public List<TransactionDTO> getListResultTransactionByLane() {
		List<TransactionDTO> result = transactionService.getTransactionsForStaff("Chưa thanh toán", 10);
	...
	public Map<String, String> requestPaymentLater(@PathVariable String transactionId) {
        ...
        /**
	 * Staff gửi yêu cầu lấy danh sách các xe trong ngày với trạng thái "Chưa thanh toán"
	 * 
	 * @param date
	 * @return
	 */
	@RequestMapping(value = "getTransactionByDate/{date}")
	@ResponseStatus(HttpStatus.OK)
	public List<TransactionDTO> getTransactionByDate(@PathVariable String date) {
		List<TransactionDTO> result = transactionService.getTransactionByDate(date, "Chưa thanh toán");               
		return result;
	}/**
	 * Staff gửi yêu cầu lấy danh sách các xe đang vào lane mình trực Server gửi
	 * danh sách các xe này và cập nhật trạng thái thành Đang xử lý
